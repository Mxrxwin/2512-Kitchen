	...
	return (
		<View style={{ flex: 1, backgroundColor: theme.backgroundColor }}>
			<DrawerContentScrollView {...props}>
				...
				>
          <TouchableOpacity style={{height: 140, width: 100}} activeOpacity={1} onPress={() => navigation.navigate("Профиль")}>
            <Image
              style={{
                height: 100,
                width: 100,
              ...
              source={{
                uri: photoURL === undefined || photoURL === null ? defaultPictureURL : photoURL,
              }}
            ></Image>
          </TouchableOpacity>
					<View
                ...
                mode={ResizeTextMode.max_lines}>
							  {displayName === undefined || displayName === null ? "Username" : displayName}
              </AutoSizeText>
