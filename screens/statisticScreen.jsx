...
const FetchDishes = (dishes, valuesToExclude, statistics, setStatistics) => {
  const updatedStatistics = { ...statistics };

  dishes.forEach((dishes) => {
    dishes.forEach((elementStr) => {
      const element = elementStr.trimEnd();
  ...
  setStatistics(updatedStatistics);
	...
	React.useEffect(() => {
      ...
      const allDishes = menuItems.map((item) => item.dishes);
      FetchDishes(allDishes, valuesToExclude, statistics, setStatistics);
      setItems(menuItems);
		});
